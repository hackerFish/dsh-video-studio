window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var __whale_jsx_runtime = (function () {
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React = require("react"), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef2 = React.useRef, useEffect4 = React.useEffect, useMemo2 = React.useMemo, useDebugValue2 = React.useDebugValue;
...
var import_jsx_runtime = __whale_jsx_runtime;
...
// node_modules/@xyflow/react/dist/esm/index.js
var import_react_dom = __whale_react_dom;
...
function StageNode({ data, selected: selected2 }) {
  const [prompt, setPrompt] = (0, import_react3.useState)(data.prompt ?? "");
  const [busy, setBusy] = (0, import_react3.useState)(false);
  const run = (0, import_react3.useCallback)(async () => {
    setBusy(true);
    try {
      const isStory = data.stage === "storyboard";
      if (data.comfy) {
        const res2 = await fetch("/dsh-video-studio/comfyui/run", {
          method: "POST",
          headers: { "content-type": "application/json" },
          body: JSON.stringify({ prompt, checkpoint: data.ckpt, width: data.width ?? 768, height: data.height ?? 768 })
        });
        data.onResult(data.stage, await res2.json());
        setBusy(false);
        return;
      }
      const body = isStory ? { outline: prompt, charactersText: data.charactersText ?? "", style: data.style ?? "", aspectRatio: data.ratio ?? "16:9" } : { prompt, aspectRatio: data.ratio ?? "16:9", durationSec: 5 };
      ...
      data.onResult(data.stage, { ok: false, error: String(e?.message ?? e) });
    } finally {
      setBusy(false);
    }
  }, [prompt, data]);
  ...
  return (0, import_react3.createElement)(
    "div",
    {
      ...
      style: {
        width: 280,
        border: selected2 ? "2px solid #4176e6" : "1px solid #d0d5dd",
        borderRadius: 12,
        background: "#fff",
    ...
    (0, import_react3.createElement)(Handle, { type: "target", position: Position.Top }),
    (0, import_react3.createElement)(
      "div",
      { className: "whale-drag", style: { display: "flex", justifyContent: "space-between", alignItems: "center", cursor: "grab", color: "#111" } },
      (0, import_react3.createElement)("strong", { style: { fontSize: 13, color: "#111" } }, "\u283F " + data.icon + " " + data.label),
      (0, import_react3.createElement)("span", { style: { fontSize: 10, opacity: 0.5, color: "rgba(0,0,0,.5)" } }, data.stage)
    ),
    (0, import_react3.createElement)("textarea", {
      value: prompt,
      onChange: (e) => setPrompt(e.target.value),
      rows: data.stage === "storyboard" ? 3 : 2,
    ...
    (0, import_react3.createElement)(
      ...
      (0, import_react3.createElement)("span", { style: { fontSize: 10, opacity: 0.6, color: "rgba(0,0,0,.55)" } }, data.engine ?? "auto")
    ),
    r && (r.ok ? r.shots ? (0, import_react3.createElement)("div", { style: { fontSize: 11, background: "rgba(46,160,67,.1)", borderRadius: 6, padding: 4, color: "#111" } }, "\u5206\u955C " + r.shots.length + " \u955C\u5DF2\u751F\u6210") : r.url ? (0, import_react3.createElement)("img", { src: r.url, alt: "out", style: { width: "100%", borderRadius: 6, border: "1px solid rgba(0,0,0,.1)" } }) : (0, import_react3.createElement)("div", { style: { fontSize: 11, opacity: 0.7, color: "rgba(0,0,0,.6)" } }, "\u2705 \u5B8C\u6210") : (0, import_react3.createElement)(
      "div",
      { role: "alert", style: { fontSize: 11, color: r?.status === "quota-paused" ? "#b3870e" : "#c83c3c" } },
      (r?.status ?? "error") + ": " + (r?.error ?? r?.message ?? "")
    )),
    (0, import_react3.createElement)(Handle, { type: "source", position: Position.Bottom })
  );
}
var NODE_TYPES = { stage: StageNode };
function WhaleFlow(_props) {
  const [resultMap, setResultMap] = (0, import_react3.useState)({});
  const onResult = (0, import_react3.useCallback)((stage, j) => {
    setResultMap((m) => ({ ...m, [stage]: j }));
  }, []);
  const initNodes = [
    { id: "storyboard", type: "stage", position: { x: 0, y: 0 }, data: { stage: "storyboard", label: "\u5206\u955C", icon: "\u{1F4CB}", prompt: "\u4E09\u5E74\u524D\u4F60\u4EEC\u8E29\u6211\u51FA\u5C40\uFF0C\u4ECA\u5929\u6211\u8BA9\u4F60\u4EEC\u6240\u6709\u4EBA\u6C42\u6211\u56DE\u6765\u3002\n\u82CF\u5A49\uFF0C\u8FD9\u4EFD\u505A\u7A7A\u62A5\u544A\uFF0C\u4F60\u786E\u5B9A\u8981\u53D1\uFF1F", onResult } },
    { id: "scene", type: "stage", position: { x: 0, y: 170 }, data: { stage: "scene", label: "\u573A\u666F\u4E3B\u56FE", icon: "\u{1F3DE}\uFE0F", prompt: "\u96E8\u591C\u5341\u5B57\u8DEF\u53E3\uFF0C\u9713\u8679\u5012\u5F71\uFF0C\u8F66\u6D41\u5149\u8F68", onResult } },
    { id: "props", type: "stage", position: { x: 0, y: 340 }, data: { stage: "props", label: "\u9053\u5177\u56FE", icon: "\u{1F392}", prompt: "\u4E00\u652F\u65E7\u624B\u673A\uFF0C\u5C4F\u5E55\u4EAE\u7740 K \u7EBF", onResult } },
    { id: "per-shot", type: "stage", position: { x: 0, y: 510 }, data: { stage: "per-shot", label: "\u9010\u955C\u8D44\u4EA7\u56FE", icon: "\u{1F39E}\uFE0F", prompt: "\u6797\u8D8A\u96E8\u591C\u9A91\u624B\u88C5\u7AD9\u5728\u5341\u5B57\u8DEF\u53E3\uFF0C\u9713\u8679\u80CC\u5149", onResult } },
    { id: "video", type: "stage", position: { x: 0, y: 680 }, data: { stage: "video", label: "\u89C6\u9891", icon: "\u{1F3AC}", prompt: "\u6797\u8D8A\u96E8\u591C\u9A91\u624B\u88C5\u7AD9\u5728\u5341\u5B57\u8DEF\u53E3\uFF0C\u9713\u8679\u80CC\u5149\uFF0C\u96E8\u4E1D\u6E05\u6670", onResult } },
    { id: "final-cut", type: "stage", position: { x: 0, y: 850 }, data: { stage: "final-cut", label: "\u6210\u7247", icon: "\u2702\uFE0F", prompt: "\u5168\u7247\u526A\u8F91\u5408\u6210", onResult } }
  ].map((n) => ({ ...n, data: { ...n.data, onResult: (k, j) => onResult(n.id, j), result: resultMap[n.id] } }));
  const initEdges = [
  ...
  const onConnect = (0, import_react3.useCallback)((conn) => {
    setEdges((eds) => [...eds, { ...conn, id: "e" + Date.now(), markerEnd: { type: MarkerType.ArrowClosed } }]);
  }, [setEdges]);
  ...
  const addNodeAt = (x, y) => {
    ...
    setNodes((nds) => [...nds, {
      ...
      type: "stage",
      position: { x, y },
      data: { stage: "per-shot", label: "\u81EA\u5B9A\u4E49\u8282\u70B9", icon: "\u{1F527}", prompt: "\u81EA\u5B9A\u4E49\u63D0\u793A\u8BCD", onResult: (k, j) => onResult(id2, j), onDelete: () => setNodes((cur) => cur.filter((n) => n.id !== id2)) }
    }]);
  };
  const addNode = () => addNodeAt(120 + Math.random() * 240, 60 + Math.random() * 200);
  const exportJson = () => {
    const payload = { kind: "whale-flow", version: 1, nodes: nodes.map((n) => ({ id: n.id, stage: n.data?.stage, label: n.data?.label, prompt: n.data?.prompt, x: n.position?.x, y: n.position?.y })), edges: edges.map((e) => ({ id: e.id, source: e.source, target: e.target })) };
    const blob = new Blob([JSON.stringify(payload, null, 2)], { type: "application/json" });
    const a = document.createElement("a");
    a.href = URL.createObjectURL(blob);
    a.download = "whale-workflow.json";
    a.click();
  };
  const importJson = (ev) => {
    ...
    reader.onload = () => {
      try {
        ...
        const comfy = j && !Array.isArray(j) && !j.kind && Object.values(j).every((v) => v && typeof v === "object" && v.class_type);
        if (comfy) {
          const imported = Object.entries(j).map(([id2, v], i) => {
            const inputs = v.inputs ?? {};
            const promptVal = Object.values(inputs).find((x) => typeof x === "string") ?? v.class_type;
            return {
              id: "comfy-" + id2,
              type: "stage",
              position: { x: i % 3 * 320, y: Math.floor(i / 3) * 200 },
              data: { stage: "per-shot", label: String(v.class_type ?? "\u8282\u70B9"), icon: "\u{1F9E9}", prompt: String(promptVal), onResult, onDelete: () => setNodes((cur) => cur.filter((n) => n.id !== "comfy-" + id2)) }
            };
          });
          setNodes(imported);
          setEdges([]);
        } else if (j.kind === "whale-flow") {
          const imported = (j.nodes ?? []).map((n) => ({ id: n.id, type: "stage", position: { x: n.x ?? 0, y: n.y ?? 0 }, data: { stage: n.stage ?? "per-shot", label: n.label ?? "\u8282\u70B9", icon: "\u{1F527}", prompt: n.prompt ?? "", onResult, onDelete: () => setNodes((cur) => cur.filter((x) => x.id !== n.id)) } }));
          setNodes(imported);
          setEdges((j.edges ?? []).map((e) => ({ id: e.id, source: e.source, target: e.target, markerEnd: { type: MarkerType.ArrowClosed } })));
        }
      } catch (e) {
  ...
  const [ckpt, setCkpt] = (0, import_react3.useState)("");
  const [nodeTypes, setNodeTypes] = (0, import_react3.useState)([]);
  const [queue, setQueue] = (0, import_react3.useState)({ running: [], pending: [] });
  (0, import_react3.useEffect)(() => {
    let alive = true;
    const loadNodes = () => {
      fetch("/dsh-video-studio/comfyui/nodes", { cache: "no-store" }).then((r) => r.json()).then((d) => {
        if (alive && d.ok) {
          setCkpt((c) => c || (d.checkpoints?.[0] ?? ""));
          setNodeTypes(d.nodeTypes ?? []);
        }
      }).catch(() => {
      });
      fetch("/dsh-video-studio/comfyui/queue", { cache: "no-store" }).then((r) => r.json()).then((d) => {
        if (alive && d.ok) setQueue({ running: d.running ?? [], pending: d.pending ?? [] });
      }).catch(() => {
      });
    };
    loadNodes();
    const t = setInterval(loadNodes, 5e3);
    return () => {
      alive = false;
      clearInterval(t);
    };
  }, []);
  const addComfyNode = (className) => {
    const id2 = "comfy-" + className + "-" + Date.now();
    setNodes((nds) => [...nds, {
      id: id2,
      type: "stage",
      position: { x: 80 + Math.random() * 200, y: 60 + Math.random() * 240 },
      data: { stage: "per-shot", label: className, icon: "\u{1F9E9}", comfy: true, ckpt, prompt: "", onResult: (k, j) => onResult(id2, j), onDelete: () => setNodes((cur) => cur.filter((n) => n.id !== id2)) }
    }]);
  };
  const runChain = async () => {
    for (const n of nodes) {
      ...
      const body = d.stage === "storyboard" ? { outline: prompt, charactersText: d.charactersText ?? "", style: d.style ?? "", aspectRatio: d.ratio ?? "16:9" } : d.comfy ? { prompt, checkpoint: d.ckpt ?? ckpt } : { prompt, aspectRatio: d.ratio ?? "16:9", durationSec: 5 };
      ...
      try {
        ...
        onResult(id2, await res.json());
      } catch (e) {
        onResult(id2, { ok: false, error: String(e?.message ?? e) });
      }
      await new Promise((r) => setTimeout(r, 500));
    }
  };
  const sidebarItem = { padding: "4px 8px", fontSize: 11, borderRadius: 5, cursor: "pointer", color: "#111", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" };
  return (0, import_react3.createElement)(
    "div",
    { style: { width: "100%", height: "100%", minHeight: 640, position: "relative", display: "flex", flexDirection: "column" } },
    (0, import_react3.createElement)("style", null, FLOW_CSS),
    (0, import_react3.createElement)(
      "div",
      { style: { display: "flex", gap: 8, padding: "6px 8px", borderBottom: "1px solid rgba(0,0,0,.08)", alignItems: "center" } },
      (0, import_react3.createElement)("button", { onClick: addNode, style: toolbarBtn }, "\uFF0B \u6DFB\u52A0\u8282\u70B9"),
      (0, import_react3.createElement)("button", { onClick: runChain, style: { ...toolbarBtn, background: "#7c3aed", color: "#fff", border: "none" } }, "\u25B6 \u5168\u94FE\u8FD0\u884C"),
      (0, import_react3.createElement)("button", { onClick: exportJson, style: toolbarBtn }, "\u2B07 \u5BFC\u51FA JSON"),
      (0, import_react3.createElement)(
        "label",
        { style: toolbarBtn, cursor: "pointer" },
        "\u2B06 \u5BFC\u5165 JSON\uFF08\u517C\u5BB9 ComfyUI workflow\uFF09",
        (0, import_react3.createElement)("input", { type: "file", accept: ".json", onChange: importJson, style: { display: "none" } })
      ),
      (0, import_react3.createElement)("span", { style: { fontSize: 11, opacity: 0.55 } }, "\u8282\u70B9=\u751F\u6210\u6B65\u9AA4\uFF1Bcomfy \u8282\u70B9\u8D70\u672C\u5730\u5F15\u64CE\uFF1B\u8FDE\u7EBF=\u6570\u636E\u6D41")
    ),
    (0, import_react3.createElement)(
      "div",
      ...
      (0, import_react3.createElement)(
        ...
        (0, import_react3.createElement)(
          ...
          (0, import_react3.createElement)(Background, { gap: 24 }),
          (0, import_react3.createElement)(Controls, null)
        ),
        menu && (0, import_react3.createElement)(
          "div",
          { style: { position: "fixed", left: menu.x, top: menu.y, zIndex: 9999, background: "#fff", border: "1px solid rgba(0,0,0,.15)", borderRadius: 8, boxShadow: "0 4px 12px rgba(0,0,0,.15)", padding: 4, minWidth: 140 } },
          (0, import_react3.createElement)("div", { onClick: () => {
            const p = nodes.length ? nodes[nodes.length - 1]?.position ?? { x: 0, y: 0 } : { x: 0, y: 0 };
            addNodeAt(p.x + 40, p.y + 40);
            setMenu(null);
          }, style: { ...menuItem, borderBottom: "1px solid rgba(0,0,0,.06)" } }, "\uFF0B \u6DFB\u52A0\u8282\u70B9"),
          menu.nodeId && (0, import_react3.createElement)("div", { onClick: () => {
            setNodes((cur) => cur.filter((n) => n.id !== menu.nodeId));
            setMenu(null);
          }, style: menuItem }, "\u{1F5D1} \u5220\u9664\u6B64\u8282\u70B9"),
          (0, import_react3.createElement)("div", { onClick: () => {
            exportJson();
            setMenu(null);
          }, style: menuItem }, "\u2B07 \u5BFC\u51FA\u5DE5\u4F5C\u6D41"),
          (0, import_react3.createElement)("div", { onClick: () => setMenu(null), style: menuItem }, "\u2715 \u5173\u95ED")
        )
      ),
      // ComfyUI 式侧栏：checkpoint / 队列 / 节点库
      (0, import_react3.createElement)(
        "div",
        { style: { width: 210, borderLeft: "1px solid rgba(0,0,0,.08)", background: "#fafafa", padding: 8, display: "flex", flexDirection: "column", gap: 10, overflow: "auto" } },
        (0, import_react3.createElement)(
          "div",
          { style: { display: "flex", flexDirection: "column", gap: 4 } },
          (0, import_react3.createElement)("span", { style: { fontSize: 11, fontWeight: 600, color: "#111" } }, "\u6A21\u578B / checkpoint"),
          (0, import_react3.createElement)(
            "select",
            { value: ckpt, onChange: (e) => setCkpt(e.target.value), style: { ...toolbarBtn, width: "100%", padding: "4px 6px" } },
            nodeTypes.length ? nodeTypes.slice(0, 3).map(() => null) : null,
            (ckpt ? [ckpt] : []).map((c) => (0, import_react3.createElement)("option", { key: c, value: c }, c))
          )
        ),
        (0, import_react3.createElement)(
          "div",
          { style: { display: "flex", flexDirection: "column", gap: 4 } },
          (0, import_react3.createElement)("span", { style: { fontSize: 11, fontWeight: 600, color: "#111" } }, "\u961F\u5217 / queue"),
          (0, import_react3.createElement)("span", { style: { fontSize: 11, color: "rgba(0,0,0,.6)" } }, "\u8FD0\u884C: " + (queue.running.length || "\u2014")),
          (0, import_react3.createElement)("span", { style: { fontSize: 11, color: "rgba(0,0,0,.6)" } }, "\u7B49\u5F85: " + (queue.pending.length || "\u2014"))
        ),
        (0, import_react3.createElement)(
          "div",
          { style: { display: "flex", flexDirection: "column", gap: 2, flex: 1, minHeight: 0, overflow: "auto" } },
          (0, import_react3.createElement)("span", { style: { fontSize: 11, fontWeight: 600, color: "#111" } }, "\u8282\u70B9\u5E93\uFF08\u70B9\u6309\u6DFB\u52A0\uFF09"),
          (nodeTypes.length ? nodeTypes : ["\u52A0\u8F7D\u4E2D\u2026"]).map((t) => (0, import_react3.createElement)("div", { key: t, onClick: () => addComfyNode(t), style: sidebarItem, title: t }, "\u{1F9E9} " + t))
        )
      )
    )
  );
}
var menuItem = { padding: "5px 10px", fontSize: 12, borderRadius: 5, cursor: "pointer", color: "#111" };

// src/client/index.ts
var inject = ["slots"];
function Panel2({ loadHealth }) {
  const [state, setState] = (0, import_react5.useState)({ loading: true, error: null, data: null });
  ...
  if (state.loading) return (0, import_react5.createElement)("p", { role: "status" }, "Reading whale status\u2026");
  if (state.error) return (0, import_react5.createElement)("p", { role: "alert" }, "Status read failed: " + state.error);
  const d = state.data;
  return (0, import_react5.createElement)(
    "div",
    null,
    (0, import_react5.createElement)("h2", null, "\u9CB8\u5F71 \xB7 \u8D26\u53F7\u4E0E\u989D\u5EA6 / Accounts & Quota"),
    (0, import_react5.createElement)("p", null, "Version " + d.version + " \xB7 Pipeline: " + d.stages.join(" \u2192 ")),
    (0, import_react5.createElement)(
      "ul",
      null,
      d.providers.map((p) => (0, import_react5.createElement)(
        "li",
        { key: p },
        p,
...
function VideoCard(props) {
  ...
  return (0, import_react5.createElement)(
    ...
    (0, import_react5.createElement)(
      "div",
      null,
      (0, import_react5.createElement)("strong", null, "\u{1F3AC} \u9CB8\u5F71\u751F\u6210 "),
      (0, import_react5.createElement)("span", { style: { opacity: 0.75, fontSize: 13 } }, "\u72B6\u6001: " + String(status))
    ),
    args?.prompt ? (0, import_react5.createElement)("div", { style: { fontSize: 13, opacity: 0.85 } }, "\u63D0\u793A\u8BCD: " + String(args.prompt)) : null,
    message ? (0, import_react5.createElement)("div", { style: { fontSize: 13 } }, message) : null,
    url ? (0, import_react5.createElement)("video", { src: url, controls: true, style: { width: "100%", maxWidth: 420, borderRadius: 8 } }) : null
  );
}
...
function WorkbenchPanel(_props) {
  ...
  const [comfy, setComfy] = (0, import_react5.useState)(null);
  const [error, setError] = (0, import_react5.useState)(null);
  const [full, setFull] = (0, import_react5.useState)(false);
  const [view, setView] = (0, import_react5.useState)("cards");
  (0, import_react5.useEffect)(() => {
    let alive = true;
    const load = () => {
    ...
    load();
    const timer2 = setInterval(load, 3e3);
    return () => {
      alive = false;
      clearInterval(timer2);
    };
  }, []);
  if (error) return (0, import_react5.createElement)("p", { role: "alert" }, "\u5DE5\u4F5C\u53F0\u8BFB\u53D6\u5931\u8D25: " + error);
  if (!doc) return (0, import_react5.createElement)("p", { role: "status" }, "\u6B63\u5728\u8BFB\u53D6\u8FD0\u884C\u8BB0\u5F55\u2026");
  const runs = doc.runs ?? [];
  ...
  const fullStyle = full ? { position: "fixed", inset: 0, zIndex: 9990, background: "#f3f4f6", overflow: "auto", padding: "20px 28px 60px", color: "#111111" } : { ...PANEL_BG };
  const headerRow = (extra) => (0, import_react5.createElement)(
    "div",
    { style: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8, color: "#111" } },
    (0, import_react5.createElement)("h2", { style: { margin: 0, color: "#111" } }, "\u9CB8\u5F71\u5DE5\u4F5C\u53F0 / Pipeline Workbench \xB7 " + WHALE_BUILD),
    (0, import_react5.createElement)(
      "div",
      { style: { display: "flex", gap: 8, alignItems: "center" } },
      extra,
      full && (0, import_react5.createElement)("button", {
  ...
  if (full && view === "flow") {
    return (0, import_react5.createElement)(
      ...
      (0, import_react5.createElement)(
        "div",
        { style: { maxWidth: 1500, margin: "0 auto", display: "flex", flexDirection: "column", gap: 12, color: "#111" } },
        headerRow((0, import_react5.createElement)("span", { style: { fontSize: 12, opacity: 0.6, color: "#111" } }, "\u8282\u70B9 = \u6D41\u6C34\u7EBF\u4E03\u6BB5\uFF1B\u8FDE\u7EBF = \u6570\u636E\u6D41\uFF1B\u6BCF\u8282\u70B9\u53EF\u5355\u72EC\u8FD0\u884C")),
        (0, import_react5.createElement)(
          "div",
          { style: { height: "calc(100vh - 120px)", border: "1px solid rgba(0,0,0,.1)", borderRadius: 12, overflow: "hidden", background: "#fff" } },
          (0, import_react5.createElement)(WhaleFlow, null)
        )
      )
    );
  }
  ...
  return (0, import_react5.createElement)(
    ...
    (0, import_react5.createElement)(
      ...
      (0, import_react5.createElement)(
        ...
        (0, import_react5.createElement)("span", { style: { width: 10, height: 10, borderRadius: "50%", background: comfyColor, flexShrink: 0 } }),
        (0, import_react5.createElement)(
          "div",
          { style: { display: "flex", flexDirection: "column", gap: 2 } },
          (0, import_react5.createElement)("strong", null, comfyTitle),
          (0, import_react5.createElement)("span", { style: { fontSize: 12, opacity: 0.7 } }, comfyDetail || "\u672C\u5730\u6216\u8FDC\u7A0B GPU \u673A\u5730\u5740\u7686\u53EF\uFF0C\u586B\u5230\u300C\u9CB8\u5F71\u8D26\u53F7\u300D\u5373\u53EF")
        )
      ),
      // ---- 云引擎卡（不依赖 ComfyUI） ----
      (0, import_react5.createElement)(
        ...
        (0, import_react5.createElement)(
          ...
          (0, import_react5.createElement)("strong", null, "\u4E91\u5F15\u64CE / Cloud Engines"),
          (0, import_react5.createElement)("span", { style: { fontSize: 11, opacity: 0.5 } }, "\u65E0\u9700\u672C\u5730 GPU\uFF0C\u4E0E ComfyUI \u4E92\u4E0D\u4F9D\u8D56")
        ),
        (0, import_react5.createElement)(
          "div",
          ...
          ].map((e) => (0, import_react5.createElement)("span", {
            key: e.k,
            style: {
              padding: "4px 10px",
              borderRadius: 999,
      ...
      (0, import_react5.createElement)(StoryboardStudio, null),
      // ---- 提示词精调台（引擎无关，纯本地精调 → 提交云引擎） ----
      (0, import_react5.createElement)(PromptCockpit, null),
      // ---- 资产流水线看板（脚手架，占位不真生成） ----
      (0, import_react5.createElement)(
        "div",
        { style: { border: "1px solid rgba(0,0,0,.12)", borderRadius: 10, padding: "10px 14px", display: "flex", flexDirection: "column", gap: 8 } },
        (0, import_react5.createElement)(
          "div",
          { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
          (0, import_react5.createElement)("strong", null, "\u8D44\u4EA7\u6D41\u6C34\u7EBF / Asset Board"),
          (0, import_react5.createElement)("span", { style: { fontSize: 11, opacity: 0.5 } }, "\u811A\u624B\u67B6\uFF1AUI \u5148\u884C\uFF0C\u771F\u5B9E\u751F\u6210\u540E\u7EED\u63A5\u5165")
        ),
        (0, import_react5.createElement)(
          "div",
          { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 8 } },
          ASSET_STAGES.map((a) => (0, import_react5.createElement)(
            "div",
            {
              key: a.id,
            ...
            (0, import_react5.createElement)("span", { style: { fontSize: 12 } }, a.label),
            (0, import_react5.createElement)("span", { style: { fontSize: 10, opacity: 0.6, textAlign: "center" } }, a.hint)
          ))
        ),
        lastRun && (0, import_react5.createElement)(
          "div",
          ...
          runImages.length > 0 && (0, import_react5.createElement)(
            "div",
            { style: { display: "flex", gap: 6, flexWrap: "wrap" } },
            runImages.map((u, i) => (0, import_react5.createElement)("img", { key: i, src: u, alt: "asset" + i, style: { width: 64, height: 64, objectFit: "cover", borderRadius: 6, border: "1px solid rgba(0,0,0,.1)" } }))
          ),
          (0, import_react5.createElement)(
            "span",
            { style: { fontSize: 11, opacity: 0.5 } },
      ...
      runs.length === 0 ? (0, import_react5.createElement)("p", null, "\u6682\u65E0\u8FD0\u884C\u8BB0\u5F55\u2014\u2014\u5728\u4F1A\u8BDD\u91CC\u8C03\u7528 whale_generate_video \u540E\uFF0C\u8FD9\u91CC\u4F1A\u663E\u793A\u4E03\u6BB5\u6D41\u6C34\u7EBF\u8FDB\u5EA6\u3002") : runs.map((run) => {
        ...
        return (0, import_react5.createElement)(
          ...
          (0, import_react5.createElement)(
            ...
            (0, import_react5.createElement)("span", null, "\u{1F3AC} " + (run.prompt ?? "").slice(0, 40)),
            (0, import_react5.createElement)("span", null, run.provider + " \xB7 " + run.status)
          ),
          (0, import_react5.createElement)(
            "div",
            ...
            Object.keys(WHALE_STAGE_LABELS).map((s) => {
              ...
              return (0, import_react5.createElement)("span", { key: s, style: style2 }, (done ? "\u2713 " : current ? "\u25C9 " : "\u25CB ") + WHALE_STAGE_LABELS[s]);
            })
          ),
          (0, import_react5.createElement)(
            "div",
...
function StoryboardStudio(_props) {
  const [outline, setOutline] = (0, import_react5.useState)("\u4E09\u5E74\u524D\u4F60\u4EEC\u8E29\u6211\u51FA\u5C40\uFF0C\u4ECA\u5929\u6211\u8BA9\u4F60\u4EEC\u6240\u6709\u4EBA\u6C42\u6211\u56DE\u6765\u3002\n\u82CF\u5A49\uFF0C\u8FD9\u4EFD\u505A\u7A7A\u62A5\u544A\uFF0C\u4F60\u786E\u5B9A\u8981\u53D1\uFF1F");
  const [charsText, setCharsText] = (0, import_react5.useState)("\u6797\u8D8A|28\u5C81\u7537\u6027\uFF0C\u5229\u843D\u9ED1\u77ED\u53D1\uFF0C\u51B7\u5CFB\u773C\u795E\uFF0C\u85CF\u9752\u51B2\u950B\u8863\n\u82CF\u5A49|26\u5C81\u5973\u6027\uFF0C\u6DF1\u68D5\u957F\u76F4\u53D1\uFF0C\u7C73\u8272\u98CE\u8863\uFF0C\u94F6\u6846\u773C\u955C");
  const [style2, setStyle] = (0, import_react5.useState)("3D \u56FD\u6F2B\u5199\u5B9E\uFF0C\u7535\u5F71\u7EA7\u90FD\u5E02\u591C\u666F\uFF0C\u51B7\u8272\u9713\u8679");
  const [ratio, setRatio] = (0, import_react5.useState)("9:16");
  const [plan, setPlan] = (0, import_react5.useState)(null);
  const [busy, setBusy] = (0, import_react5.useState)(false);
  const [shotsOut, setShotsOut] = (0, import_react5.useState)({});
  const [running, setRunning] = (0, import_react5.useState)(null);
  ...
  const build = () => {
    ...
    fetch("/dsh-video-studio/storyboard", {
      method: "POST",
      headers: { "content-type": "application/json" },
      body: JSON.stringify({ outline, charactersText: charsText, style: style2 || void 0, aspectRatio: ratio })
  ...
  const section = (title, sub, children2) => (0, import_react5.createElement)(
    "div",
    { style: { ...card, padding: "12px 16px", display: "flex", flexDirection: "column", gap: 10 } },
    (0, import_react5.createElement)(
      "div",
      { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline" } },
      (0, import_react5.createElement)("strong", { style: { fontSize: 14 } }, title),
      (0, import_react5.createElement)("span", { style: { fontSize: 11, opacity: 0.55 } }, sub)
    ),
    children2
  );
  return (0, import_react5.createElement)(
    ...
    section(
      ...
      (0, import_react5.createElement)(
        ...
        (0, import_react5.createElement)("textarea", { value: outline, onChange: (e) => setOutline(e.target.value), rows: 3, placeholder: "\u5927\u7EB2\uFF08\u6309\u53E5\u5B50/\u6362\u884C\u81EA\u52A8\u62C6\u5206\u4E3A\u955C\u5934\uFF09", style: { ...inputStyle, width: "100%", boxSizing: "border-box" } }),
        (0, import_react5.createElement)("textarea", { value: charsText, onChange: (e) => setCharsText(e.target.value), rows: 2, placeholder: "\u89D2\u8272\u6E05\u5355\uFF1A\u6BCF\u884C \u540D\u5B57|\u63CF\u8FF0", style: { ...inputStyle, width: "100%", boxSizing: "border-box" } }),
        (0, import_react5.createElement)(
          "div",
          { style: { display: "flex", gap: 8, flexWrap: "wrap" } },
          (0, import_react5.createElement)("input", { value: style2, onChange: (e) => setStyle(e.target.value), placeholder: "\u98CE\u683C", style: { ...inputStyle, flex: 1, minWidth: 180 } }),
          (0, import_react5.createElement)(
            "select",
            { value: ratio, onChange: (e) => setRatio(e.target.value), style: inputStyle },
            ["9:16", "16:9", "1:1", "4:3", "3:4"].map((r) => (0, import_react5.createElement)("option", { key: r, value: r }, r))
          ),
          (0, import_react5.createElement)("button", { onClick: build, disabled: busy, style: { ...inputStyle, background: "#4176e6", color: "#fff", border: "none", cursor: "pointer" } }, busy ? "\u62C6\u89E3\u4E2D\u2026" : "\u{1F4CB} \u751F\u6210\u5206\u955C")
        )
      )
    )
  ), plan && !plan.ok && (0, import_react5.createElement)("div", { role: "alert", style: { fontSize: 12, color: "#c83c3c" } }, "\u5931\u8D25: " + (plan.error ?? "")), plan && plan.ok && (0, import_react5.createElement)(
    "div",
    { style: { display: "flex", flexDirection: "column", gap: 10 } },
    // 角色提示词卡
    plan.characters.length > 0 && section(
      ...
      (0, import_react5.createElement)(
        ...
        plan.characters.map((c) => (0, import_react5.createElement)(
          "div",
          { key: c.name, style: { ...card, padding: 10, display: "flex", flexDirection: "column", gap: 6 } },
          (0, import_react5.createElement)(
            "div",
            { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
            (0, import_react5.createElement)("strong", null, "\u{1F9D1} " + c.name),
            (0, import_react5.createElement)("button", { onClick: () => copy(c.prompt), style: { fontSize: 11, border: "1px solid rgba(0,0,0,.2)", borderRadius: 5, background: "none", cursor: "pointer", padding: "2px 8px" } }, "\u590D\u5236")
          ),
          (0, import_react5.createElement)("div", { style: { fontSize: 11, opacity: 0.65, maxHeight: 96, overflow: "hidden" } }, c.prompt)
        ))
      )
    ),
    // 逐镜提示词
    section(
      ...
      "\u6BCF\u955C\u9876\u7EA7\u63D0\u793A\u8BCD\uFF0C\u53EF\u5355\u72EC\u751F\u6210\u6216\u4E00\u952E\u5F00\u505A",
      (() => {
        const rows = plan.shots.map((s) => (0, import_react5.createElement)(
          "div",
          { key: s.index, style: { ...card, padding: 10, display: "flex", flexDirection: "column", gap: 6 } },
          (0, import_react5.createElement)(
            "div",
            { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
            (0, import_react5.createElement)("strong", { style: { fontSize: 13 } }, "\u955C " + (s.index + 1) + " \xB7 " + s.line),
            (0, import_react5.createElement)(
              "div",
              { style: { display: "flex", gap: 6 } },
              (0, import_react5.createElement)("button", { onClick: () => copy(s.prompt), style: { fontSize: 11, border: "1px solid rgba(0,0,0,.2)", borderRadius: 5, background: "none", cursor: "pointer", padding: "2px 8px" } }, "\u590D\u5236"),
              (0, import_react5.createElement)("button", { onClick: () => genOne(s.index, s.prompt), disabled: running === s.index, style: { fontSize: 11, border: "none", borderRadius: 5, background: "#2ea043", color: "#fff", cursor: "pointer", padding: "2px 8px" } }, running === s.index ? "\u751F\u6210\u4E2D\u2026" : "\u751F\u6210\u6B64\u955C")
            )
          ),
          (0, import_react5.createElement)("div", { style: { fontSize: 11, opacity: 0.7 } }, s.prompt),
          shotsOut[s.index] && (shotsOut[s.index].ok ? (0, import_react5.createElement)("img", { src: shotsOut[s.index].url, alt: "shot" + s.index, style: { maxWidth: 220, borderRadius: 6, border: "1px solid rgba(0,0,0,.1)" } }) : (0, import_react5.createElement)(
            "div",
        ...
        const runBtn = (0, import_react5.createElement)("button", { onClick: runAll, style: { alignSelf: "flex-start", ...inputStyle, background: "#7c3aed", color: "#fff", border: "none", cursor: "pointer" } }, "\u{1F3AC} \u4E00\u952E\u5F00\u505A\uFF08\u987A\u5E8F\u751F\u6210\uFF09");
        return (0, import_react5.createElement)("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, ...rows, runBtn);
      })()
    )
  );
}
function PromptCockpit(_props) {
  const [draft, setDraft] = (0, import_react5.useState)("\u4E00\u53EA\u9CB8\u9C7C\u5728\u6DF1\u6D77\u4E2D\u6E38\u52A8\uFF0C\u84DD\u8272\u8C03\uFF0C\u7535\u5F71\u611F");
  const [style2, setStyle] = (0, import_react5.useState)("3D \u56FD\u6F2B\u5199\u5B9E\uFF0C\u7535\u5F71\u7EA7");
  const [template, setTemplate] = (0, import_react5.useState)("");
  const [ratio, setRatio] = (0, import_react5.useState)("16:9");
  const [result, setResult] = (0, import_react5.useState)(null);
  const [busy, setBusy] = (0, import_react5.useState)(false);
  const [gen, setGen] = (0, import_react5.useState)(null);
  const optimize = () => {
    setBusy(true);
    fetch("/dsh-video-studio/prompt-optimize", {
      method: "POST",
      headers: { "content-type": "application/json" },
      body: JSON.stringify({ prompt: draft, style: style2 || void 0, template: template || void 0, aspectRatio: ratio })
    }).then((r) => r.json()).then((d) => {
      setBusy(false);
      setResult(d);
    }).catch((e) => {
  ...
  return (0, import_react5.createElement)(
    ...
    (0, import_react5.createElement)(
      "div",
      { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
      (0, import_react5.createElement)("strong", null, "\u63D0\u793A\u8BCD\u7CBE\u8C03\u53F0 / Prompt Cockpit"),
      (0, import_react5.createElement)("span", { style: { fontSize: 11, opacity: 0.5 } }, "\u7EAF\u672C\u5730\u7CBE\u8C03\uFF08\u6A21\u677F+\u589E\u76CA\u5E93\uFF09\uFF0C\u65E0 GPU \u4E5F\u80FD\u7528")
    ),
    ...
    (0, import_react5.createElement)(
      "div",
      { style: { display: "flex", gap: 8, flexWrap: "wrap" } },
      (0, import_react5.createElement)("input", { value: style2, onChange: (e) => setStyle(e.target.value), placeholder: "\u98CE\u683C", style: { ...inputStyle, flex: 1, minWidth: 160 } }),
      (0, import_react5.createElement)(
        "select",
        { value: template, onChange: (e) => setTemplate(e.target.value), style: inputStyle },
        (0, import_react5.createElement)("option", { value: "" }, "\u4E0D\u5957\u6A21\u677F"),
        (0, import_react5.createElement)("option", { value: "character-sheet" }, "\u89D2\u8272\u4E09\u89C6\u56FE"),
        (0, import_react5.createElement)("option", { value: "scene-master" }, "\u573A\u666F\u4E3B\u56FE"),
        (0, import_react5.createElement)("option", { value: "shot-scene" }, "\u5355\u955C\u753B\u9762")
      ),
      (0, import_react5.createElement)(
        "select",
        { value: ratio, onChange: (e) => setRatio(e.target.value), style: inputStyle },
        ["16:9", "9:16", "1:1", "4:3", "3:4"].map((r) => (0, import_react5.createElement)("option", { key: r, value: r }, r))
      ),
      (0, import_react5.createElement)("button", { onClick: optimize, disabled: busy, style: { ...inputStyle, background: "#4176e6", color: "#fff", border: "none", cursor: "pointer" } }, busy ? "\u7CBE\u8C03\u4E2D\u2026" : "\u26A1 \u7CBE\u8C03\u5230\u9876\u7EA7"),
      (0, import_react5.createElement)("button", { onClick: generate, style: { ...inputStyle, background: "#2ea043", color: "#fff", border: "none", cursor: "pointer" } }, "\u{1F3AC} \u63D0\u4EA4\u751F\u6210")
    ),
    result && (result.ok ? (0, import_react5.createElement)(
      "div",
      { style: { display: "flex", flexDirection: "column", gap: 4, fontSize: 12 } },
      (0, import_react5.createElement)("div", null, "\u4F18\u5316\u540E\uFF08\u589E\u76CA " + result.appliedBoosters.length + " \u9879\uFF09\uFF1A" + result.optimized),
      (0, import_react5.createElement)("div", { style: { opacity: 0.7 } }, "\u8D1F\u9762: " + (result.negative ?? []).join("\uFF0C"))
    ) : (0, import_react5.createElement)("div", { role: "alert", style: { fontSize: 12, color: "#c83c3c" } }, "\u7CBE\u8C03\u5931\u8D25: " + (result.error ?? ""))),
    gen && gen.running && (0, import_react5.createElement)("div", { style: { fontSize: 12, opacity: 0.7 } }, "\u751F\u6210\u4E2D\uFF08\u989D\u5EA6\u62A4\u680F\u751F\u6548\uFF0C\u9ED8\u8BA4\u8D70\u6C60\u5185\u5065\u5EB7\u5F15\u64CE\uFF09\u2026"),
    gen && !gen.running && (gen.ok ? (0, import_react5.createElement)(
      "div",
      { style: { display: "flex", flexDirection: "column", gap: 6 } },
      (0, import_react5.createElement)("span", { style: { fontSize: 12, opacity: 0.8 } }, "\u2705 \u5DF2\u751F\u6210\uFF08" + (gen.engine ?? "") + "\uFF09"),
      (0, import_react5.createElement)("img", { src: gen.url, alt: "generated", style: { width: "100%", maxWidth: 320, borderRadius: 8, border: "1px solid rgba(0,0,0,.1)" } })
    ) : (0, import_react5.createElement)(
      "div",
...
function AccountPanel(_props) {
  ...
  const [error, setError] = (0, import_react5.useState)(null);
  const [busy, setBusy] = (0, import_react5.useState)(false);
  const [form, setForm] = (0, import_react5.useState)({ provider: "jimeng", credential: "", dailyQuota: "66", note: "" });
  const reload = () => {
  ...
  const remove2 = (id2) => {
    setBusy(true);
    fetch("/dsh-video-studio/accounts?id=" + encodeURIComponent(id2), { method: "DELETE" }).then((r) => r.json()).then(() => {
      setBusy(false);
      reload();
    }).catch((e) => {
      setBusy(false);
  ...
  return (0, import_react5.createElement)(
    ...
    (0, import_react5.createElement)("h2", null, "\u9CB8\u5F71\u8D26\u53F7 / Account Vault"),
    (0, import_react5.createElement)(
      "p",
      { style: { opacity: 0.7, fontSize: 13 } },
      "\u51ED\u8BC1\u53EA\u4FDD\u5B58\u5728\u672C\u673A ~/.whale/whale.json\uFF080600 \u6743\u9650\uFF09\uFF0C\u63A5\u53E3\u53EA\u8FD4\u56DE\u8131\u654F\u63D0\u793A\u3002\u591A\u8D26\u53F7\u6309\u65E5\u989D\u5EA6\u8F6E\u6362\uFF0C\u5931\u8D25\u81EA\u52A8\u51B7\u5374\u3002"
    ),
    error ? (0, import_react5.createElement)("p", { role: "alert" }, "\u64CD\u4F5C\u5931\u8D25: " + error) : null,
    (0, import_react5.createElement)(
      "div",
      { style: { display: "flex", gap: 8, flexWrap: "wrap" } },
      (0, import_react5.createElement)("select", {
        ...
        style: inputStyle
      }, Object.keys(PROVIDER_LABELS).map((p) => (0, import_react5.createElement)("option", { key: p, value: p }, PROVIDER_LABELS[p]))),
    ...
    accounts.length === 0 ? (0, import_react5.createElement)("p", { style: { opacity: 0.6 } }, "\u6682\u65E0\u8D26\u53F7\u2014\u2014\u628A\u514D\u8D39\u7684\u5373\u68A6/\u901A\u4E49/\u8C46\u5305\u51ED\u8BC1\u6302\u8FDB\u6765\uFF0C\u8C03\u5EA6\u5668\u4F1A\u81EA\u52A8\u8F6E\u6362\u3002") : accounts.map((a) => (0, import_react5.createElement)(
      "div",
      {
        key: a.id,
        style: { border: "1px solid rgba(0,0,0,.12)", borderRadius: 10, padding: "8px 12px", display: "flex", alignItems: "center", gap: 10 }
      },
      (0, import_react5.createElement)("strong", null, PROVIDER_LABELS[a.provider] ?? a.provider),
      (0, import_react5.createElement)("code", { style: { fontSize: 12 } }, a.credentialHint),
      (0, import_react5.createElement)("span", { style: { fontSize: 12, opacity: 0.7 } }, "\u65E5\u989D\u5EA6 " + (a.dailyQuota ?? "\u221E")),
      a.note ? (0, import_react5.createElement)("span", { style: { fontSize: 12, opacity: 0.7 } }, a.note) : null,
      (0, import_react5.createElement)("button", {
        onClick: () => remove2(a.id),
        disabled: busy,
...
function StudioToolView(_props) {
  return (0, import_react5.createElement)(
    "div",
    { style: { background: "#fff", color: "#111", borderRadius: 12, border: "1px solid rgba(0,0,0,.1)", padding: 12, display: "flex", flexDirection: "column", gap: 8 } },
    (0, import_react5.createElement)(
      "div",
      { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
      (0, import_react5.createElement)("strong", { style: { fontSize: 14, color: "#111" } }, "\u{1F3AC} \u9CB8\u5F71\u5DE5\u574A \xB7 \u8282\u70B9\u5F0F\u5DE5\u4F5C\u533A"),
      (0, import_react5.createElement)("span", { style: { fontSize: 11, color: "rgba(0,0,0,.5)" } }, "\u53EF\u62D6\u62FD/\u8FDE\u7EBF/\u53F3\u952E\u6DFB\u52A0\u8282\u70B9 \xB7 \u517C\u5BB9 ComfyUI workflow JSON")
    ),
    (0, import_react5.createElement)(
      "div",
      { style: { height: 460, border: "1px solid rgba(0,0,0,.1)", borderRadius: 10, overflow: "hidden", background: "#fafafa" } },
      (0, import_react5.createElement)(WhaleFlow, null)
    )
  );
}
