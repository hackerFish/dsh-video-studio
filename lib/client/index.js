...
function StageNode({ data, selected: selected2 }) {
  ...
  return (0, import_react3.createElement)(
    ...
    (0, import_react3.createElement)(
      ...
      (0, import_react3.createElement)("strong", { style: { fontSize: 13 } }, data.icon + " " + data.label),
      (0, import_react3.createElement)("span", { style: { fontSize: 10, opacity: 0.5 } }, data.stage)
    ),
    ...
    (0, import_react3.createElement)(
      ...
      (0, import_react3.createElement)("span", { style: { fontSize: 10, opacity: 0.6 } }, data.engine ?? "auto")
    ),
    r && (r.ok ? r.shots ? (0, import_react3.createElement)("div", { style: { fontSize: 11, background: "rgba(46,160,67,.1)", borderRadius: 6, padding: 4 } }, "\u5206\u955C " + r.shots.length + " \u955C\u5DF2\u751F\u6210") : r.url ? (0, import_react3.createElement)("img", { src: r.url, alt: "out", style: { width: "100%", borderRadius: 6, border: "1px solid rgba(0,0,0,.1)" } }) : (0, import_react3.createElement)("div", { style: { fontSize: 11, opacity: 0.7 } }, "\u2705 \u5B8C\u6210") : (0, import_react3.createElement)(
      "div",
...
function WhaleFlow(_props) {
  ...
  const addNode = () => {
    ...
    setNodes((nds) => [...nds, {
      id: id2,
      type: "stage",
      position: { x: 120 + Math.random() * 240, y: 60 + Math.random() * 200 },
...
function WorkbenchPanel(_props) {
  ...
  const headerRow = (extra) => (0, import_react5.createElement)(
    ...
    (0, import_react5.createElement)("h2", { style: { margin: 0 } }, "\u9CB8\u5F71\u5DE5\u4F5C\u53F0 / Pipeline Workbench \xB7 " + WHALE_BUILD),
    (0, import_react5.createElement)(
      "div",
  ...
  if (full && view === "flow") {
    return (0, import_react5.createElement)(
      ...
      (0, import_react5.createElement)(
        "div",
        { style: { maxWidth: 1500, margin: "0 auto", display: "flex", flexDirection: "column", gap: 12 } },
        headerRow((0, import_react5.createElement)("span", { style: { fontSize: 12, opacity: 0.6 } }, "\u8282\u70B9 = \u6D41\u6C34\u7EBF\u4E03\u6BB5\uFF1B\u8FDE\u7EBF = \u6570\u636E\u6D41\uFF1B\u6BCF\u8282\u70B9\u53EF\u5355\u72EC\u8FD0\u884C")),
        (0, import_react5.createElement)(
          "div",
          { style: { height: "calc(100vh - 120px)", border: "1px solid rgba(0,0,0,.1)", borderRadius: 12, overflow: "hidden" } },
