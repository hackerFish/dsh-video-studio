...
function WorkbenchPanel(_props) {
  ...
  const comfyTitle = comfyState === "online" ? "ComfyUI \u5728\u7EBF" : comfyState === "offline" ? "ComfyUI \u79BB\u7EBF" : comfyState === "not-configured" ? "ComfyUI \u672A\u914D\u7F6E" : "ComfyUI \u72B6\u6001\u8BFB\u53D6\u4E2D\u2026";
  const comfyDetail = comfyState === "online" ? `GPU: ${comfy.gpu ?? "unknown"} \xB7 \u961F\u5217 \u8FD0\u884C${comfy.queue?.running ?? 0}/\u7B49\u5F85${comfy.queue?.pending ?? 0}` : comfyState === "offline" ? comfy.error ?? "\u65E0\u6CD5\u8FDE\u63A5" : comfyState === "not-configured" ? comfy.hint ?? "" : "";
  return (0, import_react.createElement)(
    "div",
    ...
    (0, import_react.createElement)(
      ...
      (0, import_react.createElement)(
        ...
        (0, import_react.createElement)("span", { style: { fontSize: 12, opacity: 0.7 } }, comfyDetail || "\u672C\u5730 GPU \u5F15\u64CE\uFF0Cwhale_comfyui_workflow \u751F\u6210 workflow \u540E\u5728\u6B64\u6267\u884C")
      )
    ),
