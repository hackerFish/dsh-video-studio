...
function Panel({ loadHealth }) {
  ...
  if (state.loading) return import_react.default.createElement("p", { role: "status" }, "Reading whale status\u2026");
  if (state.error) return import_react.default.createElement("p", { role: "alert" }, "Status read failed: " + state.error);
  const d = state.data;
  return import_react.default.createElement(
    "div",
    null,
    import_react.default.createElement("h2", null, "\u9CB8\u5F71 \xB7 \u8D26\u53F7\u4E0E\u989D\u5EA6 / Accounts & Quota"),
    import_react.default.createElement("p", null, "Version " + d.version + " \xB7 Pipeline: " + d.stages.join(" \u2192 ")),
    import_react.default.createElement(
      "ul",
      null,
      d.providers.map((p) => import_react.default.createElement(
        "li",
        { key: p },
        p,
...
function VideoCard(props) {
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      "div",
      null,
      import_react.default.createElement("strong", null, "\u{1F3AC} \u9CB8\u5F71\u751F\u6210 "),
      import_react.default.createElement("span", { style: { opacity: 0.75, fontSize: 13 } }, "\u72B6\u6001: " + String(status))
    ),
    args?.prompt ? import_react.default.createElement("div", { style: { fontSize: 13, opacity: 0.85 } }, "\u63D0\u793A\u8BCD: " + String(args.prompt)) : null,
    message ? import_react.default.createElement("div", { style: { fontSize: 13 } }, message) : null,
    url ? import_react.default.createElement("video", { src: url, controls: true, style: { width: "100%", maxWidth: 420, borderRadius: 8 } }) : null
  );
}
...
function WorkbenchPanel(_props) {
  const [doc, setDoc] = import_react.default.useState(null);
  ...
  if (error) return import_react.default.createElement("p", { role: "alert" }, "\u5DE5\u4F5C\u53F0\u8BFB\u53D6\u5931\u8D25: " + error);
  if (!doc) return import_react.default.createElement("p", { role: "status" }, "\u6B63\u5728\u8BFB\u53D6\u8FD0\u884C\u8BB0\u5F55\u2026");
  const runs = doc.runs ?? [];
  return import_react.default.createElement(
    "div",
    { style: { display: "flex", flexDirection: "column", gap: 16 } },
    import_react.default.createElement("h2", null, "\u9CB8\u5F71\u5DE5\u4F5C\u53F0 / Pipeline Workbench"),
    runs.length === 0 ? import_react.default.createElement("p", null, "\u6682\u65E0\u8FD0\u884C\u8BB0\u5F55\u2014\u2014\u5728\u4F1A\u8BDD\u91CC\u8C03\u7528 whale_generate_video \u540E\uFF0C\u8FD9\u91CC\u4F1A\u663E\u793A\u516D\u6BB5\u6D41\u6C34\u7EBF\u8FDB\u5EA6\u3002") : runs.map((run) => {
      ...
      return import_react.default.createElement(
        ...
        import_react.default.createElement(
          ...
          import_react.default.createElement("span", null, "\u{1F3AC} " + (run.prompt ?? "").slice(0, 40)),
          import_react.default.createElement("span", null, run.provider + " \xB7 " + run.status)
        ),
        import_react.default.createElement(
          "div",
          ...
          Object.keys(WHALE_STAGE_LABELS).map((s) => {
            ...
            return import_react.default.createElement("span", { key: s, style }, (done ? "\u2713 " : current ? "\u25C9 " : "\u25CB ") + WHALE_STAGE_LABELS[s]);
          })
        ),
        import_react.default.createElement(
          "div",
