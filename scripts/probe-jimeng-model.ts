...
import { createJimengProvider, MODEL_KEYS, type JimengProvider } from '../src/providers/jimeng.ts'
...
for (const key of MODEL_KEYS) {
  try {
    ...
    console.log(`❌ ${key} → ${String(e instanceof Error ? e.message : e).slice(0, 90)}`)
  }
}
